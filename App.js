  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.topdata}>
        ...
        <Text style={styles.title}> NFT Web App Prototype</Text>
        <Text style={styles.descriptions}>Descriptions</Text>
        <Text style={styles.descrptionData}>Last year was a fantastic year for NFTs, with the market reaching a $40 billion valuation for the first time. In addition, more than $10 billion worth of NFTs are now sold every week – with NFT..</Text>
      </View>
